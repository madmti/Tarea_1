...
\draw [thick, arrows = {-Circle[open]Triangle[]Triangle}] (Revisor) --++ (Articulo) node[midway, rotate=-32, below] {$\leftarrow$ Es asignado a 0 o mas $\leftarrow$};

\draw [thick,-{Triangle}{Triangle}] (Articulo) --++ (Autor) node[midway, above] {$\rightarrow$ Tiene 1 o mas $\rightarrow$};
\draw [thick, arrows = {-Circle[open]Triangle[]Triangle}] (Autor) --++ (Articulo) node[midway, below] {$\leftarrow$ Dueño de 0 o mas $\leftarrow$};
...
\begin{tikzpicture}
    ...
    \draw [thick, arrows = {-Circle[open]Triangle[]Triangle}] (Revisor) --++ (Revision) node[midway, rotate=-90, above] {Realizada por un $\rightarrow$};
    \draw [thick, -{Triangle}] (Revision) --++ (Revisor) node[midway, rotate=90, above] {Realiza 0 o mas $\rightarrow$};
    ...
    \draw [thick, arrows = {-Circle[open]Triangle[]Triangle}] (Autor) --++ (Propiedad) node[midway, above] {Impuesta por un $\rightarrow$};
    \draw [thick, -{Triangle}] (Propiedad) --++ (Autor) node[midway, below] {$\leftarrow$ Tiene 0 o mas};
